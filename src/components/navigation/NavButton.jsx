import { FileCheck2, GitBranchPlus, Github, Home, Linkedin, NotebookText, Palette, Phone, Twitter, User } from 'lucide-react'
...
const getIcon = (icon)=>{
    switch (icon){
        ...
        case "certificate":
            return <FileCheck2 className='w-full h-auto' strokeWidth={1.5}/>
        case "resume":
